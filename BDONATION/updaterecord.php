            ...
            try
            {
                ...
                else
                {
                    ...
                    <div class="row">
                                ...
                                <div class="input-field">
                                <input type="radio" name="gender" value="<?=$rec['gender']?>" checked><label>Male</label>
                                <input type="radio" name="gender" value="<?=$rec['gender']?>"><label>Female</label><br/>
                                <input type="radio" name="gender" value="<?=$rec['gender']?>"><label>Third Gender</label><br/><br/>
                                </div>
                                <div class="input-field">
                                    <input type="number" placeholder="Weight" name="weight" class="form-control" value="<?=$rec['weight']?>" required/><br/>
                                </div>
                                <div class="input-field">
                                    <input type="number" placeholder="Age" name="age" class="form-control" value="<?=$rec['age']?>" required/><br/>
                                </div>
                                <div class="input-field">
                                    <input type="text" placeholder="last" name="last" class="form-control" value="<?=$rec['last']?>" required/><br/>
                                </div>
                                <div class="input-field">
                                    <input type="number" placeholder="number" name="number" class="form-control" value="<?=$rec['number']?>" required/><br/>
                                </div>
                                <div class="input-field">
                                    <input type="address" placeholder="Adress" name="address" class="form-control" value="<?=$rec['address']?>" required/><br/>
                                </div>
                                <div class="input-field">
                                    <table>
                                        <tr>
