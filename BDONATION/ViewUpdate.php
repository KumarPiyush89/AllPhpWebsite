    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                ...
                <h3 class="text-center text-denger" style=" height:250px; overflow:scroll; ">
                <?php
                //connection
                ...
                ?>
                <table class="table table-hover table-striped text-center table-bordered"style=" height:600px; overflow:scroll; ">
                    <?php
